...
if($_POST)
{
    ...
    $your_email = "mirzauzair558@gmail.com";
...
//    $mail->Port       = 587;                                    // TCP port to connect to
    ...
    if(isset($_POST["birthdate"])) {
        $mail->Body .= "<strong>Gender: </strong>" . $_POST['birthdate'] . "<br>";
    }
    $mail->Body .= '<br>';
    if(isset($_POST["age"])) {
        $mail->Body .= "<strong>Gender: </strong>" . $_POST['age'] . "<br>";
    }
    $mail->Body .= '<br>';
    if(isset($_POST["grade"])) {
        $mail->Body .= "<strong>Gender: </strong>" . $_POST['grade'] . "<br>";
    }
    $mail->Body .= '<br>';
    if(isset($_POST["skilllevel"])) {
        $mail->Body .= "<strong>Gender: </strong>" . $_POST['skilllevel'] . "<br>";
    }
    $mail->Body .= '<br>';
    if(isset($_POST["tshirt"])) {
        $mail->Body .= "<strong>Gender: </strong>" . $_POST['tshirt'] . "<br>";
    }
    $mail->Body .= '<br>';
    if(isset($_POST["gender"])) {
        $mail->Body .= "<strong>Gender: </strong>" . $_POST['gender'] . "<br>";
    }

    $mail->Body .= '<br>';
    if(isset($_POST["state"])) {
        $mail->Body .= "<strong>Gender: </strong>" . $_POST['state'] . "<br>";
    }
    $mail->Body .= '<br>';
    if(isset($_POST["Zipcode"])) {
        $mail->Body .= "<strong>Gender: </strong>" . $_POST['Zipcode'] . "<br>";
    }
